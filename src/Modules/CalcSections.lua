...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Chance to Chill", bgCol = colorCodes.CHILLBG, flag = "chill", { format = "{0:output:ChillChance}%",
		{ breakdown = "MainHand.ChillChance" },
		{ breakdown = "OffHand.ChillChance" },
		{ breakdown = "ChillChance" },
		{ label = "Player modifiers", modName = "EnemyChillChance", cfg = "skill" },
		{ label = "Enemy modifiers", modName = "SelfChillChance", enemy = true },
	}, },
