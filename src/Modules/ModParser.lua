...
local specialModList = {
	...
	["damage over time multiplier for ailments is equal to critical strike multiplier"] = function() return { mod("CritMultiplierAppliesToDegen", "BASE", 100) } end,
	...
	["non%-critical strikes cannot inflict ailments"] = function()
		local mods = { }
		for i, ailment in ipairs(data.ailmentTypeList) do
			mods[i] = mod("HitsCant"..ailment, "FLAG", true)
		end
		return mods
	end,
